...
alarm_running = False
prev_keypoints = None
movement_seen_any_camera = False
...
def start_wellness_check():
    ...
    global movement_seen_any_camera
...
# =====================================
        ...
        if keypoints is not None:
            ...
            if avg_conf > 0.35 and stable_posture != "UNKNOWN":
            ...
            if stable_posture == "LYING":
                ...
                if (
                    ...
                    and rapid_drop
                    and not state["head_drop_detected"]
                ):

                    state["head_drop_detected"] = True

                    print(
                        f"[CAM {cam_index+1}] HEAD DROP DETECTED"
                    )
            ...
            if stable_posture != "STANDING":
                state["head_drop_detected"] = False
