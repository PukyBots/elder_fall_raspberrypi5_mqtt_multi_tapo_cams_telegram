...
NTFY_TOPIC = "elder_fall_alerts_rpi5"
NTFY_URL = f"https://ntfy.sh/{NTFY_TOPIC}"

def send_ntfy_alert(cam_id, frame):
    ...
    try:
        ...
        response = requests.put(
            ...
            headers={
                ...
                "Message": f"Camera {cam_id+1} fall detected",
                "Filename": "fall.jpg",
                "Priority": "high",
        ...
        if response.status_code == 200:
            ...
            print(
                f"NTFY failed: {response.status_code}"
            )
...
# =====================================
        ...
        if keypoints is not None:
            ...
            if state["prev_nose_y"] is not None:
                ...
                lying = stable_posture == "LYING"
                fast_drop = vertical_drop > 0.25
                low_confidence = avg_conf < 0.5

                if fast_drop and (lying or low_confidence):
                    rapid_drop = True
            ...
            if rapid_drop and not state["fall_detected"]:            

                state["fall_detected"] = True
                state["last_fall_time"] = time.time()

                print(
                    f"[CAM {cam_index+1}] FALL DETECTED"
                )
            ...
            # =====================================
            # RESET FALL STATUS AFTER 10 SEC
            # =====================================
